...
export default function AnswerPage() {
  ...
  return (
    <div className="flex flex-col items-center px-4 py-6 min-h-screen bg-white text-black">
      {/* アバター */}
      <Image
      ...
      {/* 問題文 */}
      <div className="w-full max-w-xl border-2 border-blue-400 bg-white rounded-md px-4 py-2 text-center mb-4">
